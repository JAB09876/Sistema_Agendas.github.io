...
class cita
{
    ...
    public function create()
    {
        ...
        if (isset($response) && !empty($response)) {
            if ($response === "El doctor tiene citas programadas para esa fecha y hora") {
                $json = [
                    "status" => 400,
                    "result" => $response,
                ];
                ...
                $json = [
                    "status" => 200,
                    "results" => "La Cita ha sido creada con éxito",
                ];
            }
    ...
    public function update()
    {
        ...
        if (isset($response) && !empty($response)) {
            if ($response === "El doctor tiene citas programadas para esa fecha y hora") {
                ...
                $json = [
                    "status" => 200,
                    "results" => "La Cita ha sido actualizada con éxito",
                ];
            }
        } else {
            $json = [
